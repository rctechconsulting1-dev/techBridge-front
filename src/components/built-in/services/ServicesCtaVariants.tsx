...
export default function ServicesCtaVariants({ variant, themePack, settings }: Props) {
  ...
  if (variant === "quote_request") {
    return <CTASection settings={settings} variant="solid_banner" />;
  }
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.4fr_auto] lg:items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/70">
              {variant === "book_now" ? "Booking CTA" : "Consultation CTA"}
            </p>
